...
public class Hunting : MonoBehaviour
{
    ...
    public float huntRange = 10f; // the distance at which the enemy starts chasing the player
    ...
    private void Update()
    {
        ...
        HuntPlayer(distance); // method that holds the logic for enemy to chase player
    ...
    private void HuntPlayer(float distance)
    {
